...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "gb-control-toggle peer inline-flex shrink-0 items-center rounded-full border border-border/60 bg-surface-elevated outline-none transition-[background-color,border-color,box-shadow]",
