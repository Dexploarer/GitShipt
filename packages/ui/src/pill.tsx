  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        neutral: "bg-surface-elevated text-fg-secondary border border-border hover:bg-surface-overlay hover:text-fg",
    ...
    defaultVariants: { variant: "primary", size: "default", interactive: false },
  },
);
