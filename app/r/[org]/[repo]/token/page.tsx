      ...
      <div className="flex flex-col gap-4">
        <header className="flex flex-col gap-2">
          ...
          <p className="text-body-md text-fg-secondary">
            ...
            platform pool wallet and are redistributed to top contributors
            daily.
          </p>
        </header>
        ...
        {!header.tokenMint || !stats ? (
          <Card depth="raised" padding="default" className="text-center">
            ...
            <CardDescription className="mt-1 mx-auto max-w-md">
              ...
              yet. The owner can launch from the dashboard to start the daily
              fee pool.
            </CardDescription>
            ...
            <div className="flex flex-col gap-4 min-w-0">
              ...
              <Card depth="raised" padding="default">
                <CardHeader>
                  ...
                  <CardDescription>
                    Share of each cycle's contributor pool by leaderboard rank.
                  </CardDescription>
                </CardHeader>
