      ...
      <div className="flex flex-col gap-4">
        <header className="flex flex-col gap-2">
          ...
          <p className="text-body-md text-fg-secondary">
            ...
            last synced, and which signals feed the leaderboard.
          </p>
        </header>
        ...
        <Card depth="raised" padding="default">
          ...
          <CardContent className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            <Stat
              ...
              value={
                header.tokenMint ? "Active" : "Pending owner action"
              }
            />
            <Stat
        ...
        <Card depth="raised" padding="default">
          ...
          <CardContent className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
            ...
            />
            <Signal label="Window" detail={`${header.scoringConfig.windowDays} days`} />
            <Signal
              label="Time decay"
              detail={header.scoringConfig.decay}
            />
            <Signal
              label="Bot exclusion"
